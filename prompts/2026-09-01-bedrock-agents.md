...
3. **The "All connectors" table: DELETED. The "What 'yours' will mean" section: DELETED.** One trade to resolve in your report rather than relitigate: the scope sentences (drive.file's reach, calendar.events.owned's limit) and the claim-check truth lose their home — propose the smallest surviving surface for them (tooltip, one line under the heading, or a /docs page) and I'll put it to Brendan.
